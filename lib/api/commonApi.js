...
//stripeApi
export const stripePaymentCheck = (orderGuid) => api.get(`/stripe/order/status?orderGuid=${orderGuid}`)

//premiumVendors
export const getAllThePremiumVendors = () => api.get(`/website/premium-vendors?key=${api_key}`)