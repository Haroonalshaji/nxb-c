...
export const verifyVendorEmailwithOtp = (credentials) => api.post(`/auth/vendor/register/verify-otp?vendtGuid=${credentials.vendGuid}&otp=${credentials.otp}`, credentials);
